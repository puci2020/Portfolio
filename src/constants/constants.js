export const logo = '/images/web.png';

export const CV = 'Adam_Pucicki_CV.pdf';
...
export const TimeLineData = [
  {year: 2017, text: 'Starting a degree in computer science',},
  {year: 2018, text: 'Starting the adventure with web applications',},
  {year: 2019, text: 'First steps with React.js',},
  {year: 2020, text: 'Internship as a Web Developer in Angular and .NET technologies',},
